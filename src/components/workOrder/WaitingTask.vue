<template>
    <div>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="sendOrder">下 发</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
    ...
    methods:{
      get(){
          this.$axios.get('http://127.0.0.1/tasklist/waitingTaskGet').then(res=>{
      ...
      sendOrder(){
        this.$axios.get("http://127.0.0.1/tasklist/sendOrder",{
