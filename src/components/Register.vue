    ...
    <div class="register">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="居住地" prop="province">
          <el-input type="text" v-model="ruleForm.province" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="联系地址" prop="address">
          <el-input type="text" v-model="ruleForm.address" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" size="medium" @click="register">确认注册</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div>
...
<script>
    ...
    export default {
        ...
        methods: {
          register(){
            this.$axios.get("http://127.0.0.1/register/get",{
              params:{
